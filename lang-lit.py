...
import pinecone
import os
embeddings = OpenAIEmbeddings(openai_api_key ="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") # set openai_api_key = 'your_openai_api_key'
...
llm = ChatOpenAI(model_name='gpt-3.5-turbo-0301', temperature=0,openai_api_key = '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')
